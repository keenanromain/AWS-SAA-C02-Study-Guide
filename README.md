...
These notes helped me pass the newer AWS Certified Solutions Architect - Associate exam. I took the newer exam, SAA-C02, because it features the most relevant AWS technologies as part of the exam content. In order to pass, I took the relevant <a href="https://acloud.guru/learn/aws-certified-solutions-architect-associate">A Cloud Guru course</a> twice, kept up-to-date with the discussions in <a href="https://old.reddit.com/r/AWSCertifications/">r/AWSCertifications</a>, and I made use of the <a href="https://www.udemy.com/course/aws-certified-solutions-architect-associate-amazon-practice-exams-saa-c02/"> Tutorials Dojo practice exams</a>. I have almost a year's worth of professional AWS experience, but that shouldn't matter if you have a solid technical background or a good intuition for systems. Finally, I also read many of the FAQs for the most critical services which are recommended in the Introduction below.
