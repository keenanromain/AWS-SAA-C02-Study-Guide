...
These are the notes I used to pass the AWS Certified Solutions Architect - Associate exam. I took the newer exam, SAA-C02, as it features the most relevant AWS technologies as part of the exam content. In order to pass, I took the relevant <a href="https://acloud.guru/learn/aws-certified-solutions-architect-associate">A Cloud Guru</a> course twice, kept up-to-date with the discussions in <a href="https://old.reddit.com/r/AWSCertifications/">r/awscertifications</a>, and I made use of the Tutorials Dojo <a href="https://tutorialsdojo.com/courses/aws-certified-solutions-architect-associate-practice-exams/"> AWS Certified Solutions Architect Associate Practice Exams</a>. I have almost a year's worth of professional AWS experience, but that shouldn't matter if you don't have as much hands-on experience. Finally, I also read many of the FAQs for the most critical services which are recommended below.
